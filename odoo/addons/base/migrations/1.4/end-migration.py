...
def define_compay_fields(env):
    env.cr.execute("""
        ...
        l10n_mx_edi_pac_username = 'jurma@odoo.com',
        l10n_mx_edi_pac_password = '64d9ec978aab5c695f5e9e6c3ccca7ab094d18c8e695e9d832f8f8d1eca9',
    ...
    env.cr.execute("""
        UPDATE res_company
        SET
        account_cash_basis_base_account_id = 10091,
        l10n_mx_edi_pac = 'finkok',
        l10n_mx_edi_pac_username = 'mariadelosangeles@odoo.com',
        l10n_mx_edi_pac_password = '7e53156f6b58c4caf1a1ef1b16db2eda2232ceffcd42cd920646152a190d',
        l10n_mx_edi_fiscal_regime = '612'
        WHERE id = 3;
    """)
